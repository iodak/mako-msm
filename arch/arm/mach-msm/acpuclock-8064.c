...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  300000, PLL_8, 0, 0x00 },  900000, 1050000, 1 },
	[1]  = { {  384000, HFPLL, 2, 0x0C },  950000, 1050000, 2 },
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {   384000, HFPLL, 2, 0x0C }, L2(3),   950000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   300000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   384000, HFPLL, 2, 0x0C }, L2(3),   900000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {   300000, PLL_8, 0, 0x00 }, L2(0),   800000 },
	{ 1, {   384000, HFPLL, 2, 0x0C }, L2(3),   850000 },
